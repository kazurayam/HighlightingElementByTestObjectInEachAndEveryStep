...
The following image is rendered by https://github.com/kazurayam/HighlightingElementByTestObjectInEachAndEveryStep/blob/develop/Scripts/TC3b/Script1732701241909.groovy[Test Cases/TC3b]. The `com.kazurayam.ksbackyard.HighlightElement.on` keyword will apply a default style of highlight as default, like this:
